...
import font from '../fonts/mulish-v18-latin-300.woff2'
import font2 from '../fonts/mulish-v18-latin-regular.woff2'
        ...
        <div className="container">
            <div className="header__wrapper">
                ...
                <div className="header__text">
                    ...
                    <p className='header__p'>There are regular events in our pizzeria that will allow you to eat delicious food for a lower price!</p>
                </div>
            </div>
        </div>
       </header>
